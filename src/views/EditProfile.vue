    ...
    <div>
        ...
        <div class="container">
            <div class="edit-profile-image-area">
                ...
                <img v-else class="current-profile-image" :src="`http://206.189.193.136:3001/profile_img/${profileImgURI}`" alt="profile image" />
...
<script lang="ts" setup>
    ...
    const submit = async () => {
        ...
        try{ 
            ...
            await axios.patch('http://206.189.193.136:3001/api/v1/edit-profile', {
    ...
    const fetchProfileData = async () => {
        ...
        try{
            ...
            const response = await axios.get(`http://206.189.193.136:3001/api/v1/profile/member/${getUserData.username}`, {
                headers: {
                    'x-auth-token': getAuthToken.value
                }
            })
    ...
    const fetchProfileImage = async () => {
        ...
        try{
            ...
            const response = await axios.get(`http://206.189.193.136:3001/api/v1/profile-img/${getUserData.user_id}`);
